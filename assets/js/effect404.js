...
var pJS = function(e, a) {
	...
	a && Object.deepExtend(i, a), i.tmp.obj = {
		...
		for (var e = 0; e < i.particles.array.length; e++) {
			...
			if ("bounce" === (a.x - a.radius > i.canvas.w ? (a.x = n.x_left, a.y = Math.random() * i.canvas.h) : a.x + a.radius < 0 && (a.x = n.x_right, a.y = Math.random() * i.canvas.h), a.y - a.radius > i.canvas.h ? (a.y = n.y_top, a.x = Math.random() * i.canvas.w) : a.y + a.radius < 0 && (a.y = n.y_bottom, a.x = Math.random() * i.canvas.w), i.particles.move.out_mode))(a.x + a.radius > i.canvas.w || a.x - a.radius < 0) && (a.vx = -a.vx), (a.y + a.radius > i.canvas.h || a.y - a.radius < 0) && (a.vy = -a.vy);
		...
		var t = e.x - a.x,
			i = e.y - a.y,
			n = Math.sqrt(t * t + i * i);
		e.radius + a.radius >= n && (e.vx = -e.vx, e.vy = -e.vy, a.vx = -a.vx, a.vy = -a.vy)
		...
		function t(a, t, n, s, r) {
			if (a != t)
				if (i.tmp.bubble_duration_end) {
					if (null != n) o = a + (a - (s - p * (s - a) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o)
		...
		if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
			...
			if (i.tmp.bubble_clicking) {
				n = e.x - i.interactivity.mouse.click_pos_x, s = e.y - i.interactivity.mouse.click_pos_y;
